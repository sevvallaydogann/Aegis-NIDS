...
![Aegis Dashboard](images/dashboard_screenshot.png)
...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/sevvallaydogann/Aegis-NIDS.git](https://github.com/sevvallaydogann/Aegis-NIDS.git)
    cd Aegis-NIDS
    ```
